...
class ProductProvider extends ChangeNotifier {
  ...
  List<ProductModel> gitCategoryList({required String category}) {
  ...
  List<ProductModel> gitSearchList(
      {required String searchText, required List<ProductModel> listModel}) {
    List<ProductModel> categoryList = listModel
        .where(
  ...
  Future<List<ProductModel>> fetchData() async {
    try {
      await userDc.get().then((snapshot) {
        products.clear();
